...
class _EntertainmentPageState extends State<EntertainmentPage> {
  ...
  Future<void> fetchNews() async {
    ...
    const apiKey =
        'ca75fb392995439ca0b4997ec99cff08'; // Replace with your actual API key
    final url =
        'https://newsapi.org/v2/top-headlines?country=$selectedCountry&category=entertainment&apiKey=$apiKey';
